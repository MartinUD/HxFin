...
import { CurrencySchema, IsoDateTimeSchema, PercentageSchema, PositiveAmountSchema } from '$lib/schema/common';
...
export type UpdateFinancialProfileInput = Schema.Schema.Type<typeof UpdateFinancialProfileInputSchema>;
