<script lang="ts">
	...
	import { deleteRecurringCost } from '$lib/features/budget/api';
	import {
		buildCategoryMap,
		...
		type CategoryFilter
	} from '$lib/features/budget/selectors';
	import CategoriesDialog from '$lib/features/budget/recurring/local-components/CategoriesDialog.svelte';
	import CostDialog from '$lib/features/budget/recurring/local-components/CostDialog.svelte';
	import CostsTable from '$lib/features/budget/recurring/local-components/CostsTable.svelte';
	import ErrorAlert from '$lib/features/budget/recurring/local-components/ErrorAlert.svelte';
	import Toolbar from '$lib/features/budget/recurring/local-components/Toolbar.svelte';
