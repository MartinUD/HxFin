<script lang="ts">
	import InputField from '$lib/features/investments/projections/local-components/InputField.svelte';
	import LeverageSlider from '$lib/features/investments/projections/local-components/LeverageSlider.svelte';
	import SalaryGrowth from '$lib/features/investments/projections/local-components/SalaryGrowth.svelte';
